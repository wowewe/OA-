        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown menu-merge">
                <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown">
                    <img src="https://i01piccdn.sogoucdn.com/a70ac2c544b3c4ec" alt="avatar" class="mw30 br64">
                ...
                <div class="sidebar-widget author-widget">
                    <div class="media">
                        <a class="media-left" href="#">
                            <img src="https://i01piccdn.sogoucdn.com/a70ac2c544b3c4ec" class="img-responsive">
                        </a>
                        <div class="media-body">
                            <div class="media-author">admin--总经理</div>
